...
unclipped_layer = QgsProject.instance().mapLayersByName("harakeke_contours_250")[-1]
coast_layer = QgsProject.instance().mapLayersByName("harakeke_coast")[-1]
scale = 1500000
# stroke_width = 1.5
stroke_width = 0.125
...
# thick_elevation = 480
thin_elevation = 500
thick_elevation = 1000

expr1 = '  "elevation" % {} = 0'.format(thick_elevation)
expr2 = '   "elevation" % {} = 0 AND  "elevation" % {} <> 0 '.format(thin_elevation, thick_elevation)
# expr1 = '  "elevation" = 1500'
# expr2 = '  "elevation" IN (500, 1000, 2000)'

raster_layer = QgsProject.instance().mapLayersByName("harakeke_rectangle1")[-1]
